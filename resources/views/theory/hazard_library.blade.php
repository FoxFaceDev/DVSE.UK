<x-layouts.app :showBack="true" :backUrl="route('home')" title="Hazard learning videos">
    <div x-data="hazardLibrary(@js($watchedPageIds), @js(auth('web')->check()))" class="space-y-8">
            ...
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">
                        @auth('web') Synced to your DVSE.UK account across your devices. @else <a href="{{ route('login') }}" class="font-bold text-primary hover:underline">Sign in</a> to sync progress across devices. @endauth
                    </p>
                </div>
